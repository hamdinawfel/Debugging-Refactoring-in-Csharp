# Debugging-Refactoring-in-Csharp
This DEMO is built on top of IAmTimCorey tutorials 

>Starting with that messing code, and Finishing with readable, reusable code by applying some refactoring and debuggings kills
